...
class CARATE(torch.nn.Module):
    def __init__(self, in_channels, hidden_channels, out_channels, heads, dropout_gat, dropout_forward):
        ...
        self.gat1 = GATv2Conv(in_channels, hidden_channels, heads=heads, dropout=dropout_gat)
        self.gat2 = GATv2Conv(hidden_channels * heads, hidden_channels, heads=heads, dropout=dropout_gat)
        self.gat3 = GATv2Conv(hidden_channels * heads, hidden_channels, heads=heads, dropout=dropout_gat)
